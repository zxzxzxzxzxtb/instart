    ...
    public class CompanyApplyController : ManageControllerBase
    {
        ...
        public JsonResult SetAccept(int id)
        {
            ...
            try
            {
                ...
                {
                    success = _companyApplyService.SetAcceptAsync(id)
                });
            }
            catch (Exception ex)
            {
                LogHelper.Error("CompanyApplyController.SetAccept异常", ex);
